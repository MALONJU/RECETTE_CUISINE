...
class DetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgToolbarBtnFav.setOnClickListener{
            if (isLiked) {
                imgToolbarBtnFav.setBackgroundColor(ContextCompat.getColor(this, android.R.color.transparent))
                isLiked = false
            } else {
                imgToolbarBtnFav.setBackgroundColor(ContextCompat.getColor(this, android.R.color.holo_red_light))
                isLiked = true
            }
